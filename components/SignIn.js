...
export default function SignInForm() {
  ...
  return (
    <div className="w-full h-screen mx-auto flex items-center justify-center bg-white min-[499px]:max-w-[75%] md:max-w-md md:h-[100vh] md:shadow-[0_0_10px_0_rgba(0,0,0,0.2)]">
