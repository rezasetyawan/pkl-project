...
export default function SignUpForm() {
  ...
  return (
    <>
      <div
        className={`w-full h-screen mx-auto flex items-center justify-center bg-white min-[499px]:max-w-[75%] md:max-w-md md:h-[100vh] md:shadow-[0_0_10px_0_rgba(0,0,0,0.2)] md:rounded-sm md:my-0`}
      >
        <form id="signUpForm" onSubmit={handleSubmit} className="w-[75%]">
          ...
          <div>
            ...
            <p className="text-slate-600 text-sm text-center mt-2 font-sans">
              ...
              <Link href={"/auth/login"} className="text-sky-500 font-sans">
                Sign In
              </Link>
            </p>
          </div>
